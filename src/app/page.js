    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-purple-50 text-slate-900 overflow-x-hidden">
      ...
      <div id="about" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white rounded-3xl p-12 shadow-xl border border-slate-200">
          <h2 className="text-4xl font-black mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">About Us</h2>
          <div className="space-y-6 text-slate-700 text-lg leading-relaxed">
            <p>
              Founded in 1999 by visionary students from the University of Malawi, CAPS is a dynamic non-profit organization committed to eradicating poverty and tackling social challenges across Malawi. We partner with government agencies, civil society, and local communities to empower vulnerable groups through innovative, grassroots-driven initiatives.
            </p>
            <p>
              With a focus on health, education, agriculture, environment, and human rights, we've been transforming lives for over two decades, fostering resilience and self-reliance in the face of adversity. Our dedicated team of 10 volunteers works tirelessly to create lasting change, drawing inspiration from successful models like World Vision Malawi's extensive child sponsorship programs and CARE's community empowerment strategies.
            </p>
          </div>
        </div>
      </div>
...
<div className="mb-20">
  <div className="grid lg:grid-cols-2 items-stretch rounded-3xl overflow-hidden shadow-xl border border-rose-200">
    ...
    <div className="relative w-full h-full">
      ...
      />
        ...
        {/* Education & Skills Development with IMAGE 4 */}
  ...
  <div className="grid lg:grid-cols-2 items-stretch rounded-3xl overflow-hidden shadow-xl border border-blue-200">
    ...
    {/* Right side - Text with gradient background */}
    <div className="flex flex-col justify-center bg-gradient-to-br from-blue-50 to-cyan-50 p-10 order-1 lg:order-2">
      ...
      <p className="text-slate-600 italic">
        ...
        {/* Agriculture & Environment with IMAGE 5 */}
        <div className="mb-20">
  <div className="grid lg:grid-cols-2 items-stretch rounded-3xl overflow-hidden shadow-xl border border-green-200">
    ...
    <div className="relative w-full h-full">
      ...
      />
        ...
        {/* Human Rights & Social Empowerment with IMAGE 6 */}
        <div className="mb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-white rounded-3xl p-12 shadow-xl border border-slate-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <a href="#" className="group flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl transition-all duration-300 hover:scale-110 shadow-md hover:shadow-xl border border-blue-200">
              <Facebook className="w-10 h-10 text-blue-600 group-hover:scale-125 transition-transform" />
              <span className="font-bold text-slate-800">Facebook</span>
            </a>

            <a href="#" className="group flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-sky-50 to-sky-100 rounded-2xl transition-all duration-300 hover:scale-110 shadow-md hover:shadow-xl border border-sky-200">
              <Twitter className="w-10 h-10 text-sky-600 group-hover:scale-125 transition-transform" />
              <span className="font-bold text-slate-800">Twitter</span>
            </a>

            <a href="#" className="group flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl transition-all duration-300 hover:scale-110 shadow-md hover:shadow-xl border border-pink-200">
              <Instagram className="w-10 h-10 text-pink-600 group-hover:scale-125 transition-transform" />
              <span className="font-bold text-slate-800">Instagram</span>
            </a>

            <a href="#" className="group flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl transition-all duration-300 hover:scale-110 shadow-md hover:shadow-xl border border-indigo-200">
              <Linkedin className="w-10 h-10 text-indigo-600 group-hover:scale-125 transition-transform" />
